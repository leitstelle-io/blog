...
<template>
  <div class="flex flex-col md:flex-row items-center justify-between p-4">
    ...
    <nav class="space-x-10">
      <nuxt-link class="text-black hover:text-yellow-400" :to="{name: 'blog'}">Blog</nuxt-link>
      <nuxt-link class="text-black hover:text-yellow-400" :to="{name: 'faq'}">FAQ</nuxt-link>
